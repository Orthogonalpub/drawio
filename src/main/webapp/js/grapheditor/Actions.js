...
Actions.prototype.init = function()
{
	...
	this.addAction('save', function() { ui.saveToMyBackend(false); }, null, null, Editor.ctrlKey + '+S').isEnabled = isGraphEnabled;
	this.addAction('saveAs...', function() { ui.saveToMyBackend(true); }, null, null, Editor.ctrlKey + '+' + Editor.shiftKey + '+S');
